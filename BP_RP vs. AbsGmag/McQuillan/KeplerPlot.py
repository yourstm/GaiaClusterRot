...
# Reading the CSV into a pandas dataframe and making the data cuts in-code
...
plt.scatter(Kepler[["bp_rp"]], Kepler[["abs_gmag"]] - 5, marker = "v", s = 0.5, c = Kepler[["Prot"]], label = "Kepler", cmap = cm)
plt.ylabel("$M_G$ (mag)")
...
ax2.scatter(Kepler[["bp_rp"]], Kepler[["abs_gmag"]] - 5, marker = "v", s = 7, c = Kepler[["Prot"]], cmap = cm)
